...
Тут сложно, больно и долго, но задание в тренировочном тесте однотипное можно просто и запомнить.
Ниже я хотел привести формулы для решения, но понял что показал в итоге решение задачи.
